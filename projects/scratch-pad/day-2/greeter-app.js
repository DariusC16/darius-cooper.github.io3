...
function greeter(hour) {
    ...
    // IF HOUR IS LESS THAN OR EQUAL TO 11
     if (hour <= 11) {
        // CONSOLE LOG GOOD MORNING  
         console.log('Good Morning!');
     } // IF HOUR IS LESS THAN OR EQUAL TO 16
        else if (hour <= 16) {
            // CONSOLE LOG GOOD AFTERNOON
             console.log('Good Afternoon!');
        } // IF HOUR IS LESS THAN OR EQUAL TO 21
           else if (hour <= 21) {
            // COCNSOLE LOG GOOD EVENING 
             console.log('Good Evening!');
           } // IF HOUR IS LESS THAN OR EQUAL TO 24
              else if (hour <= 24) {
                // CONSOLE LOG GOOD NIGHT
                 console.log('Good Night!');
                } else {
                    console.log('Time is not readable');
                }
